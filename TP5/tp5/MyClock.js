...
MyClock.prototype.update = function(currTime)
{
	if (this.previousTime == 0)
	{
		...
		var elapsedSeconds = Math.round(currTime / 1000);
	...
	{
		this.secondsHand.setAngle(this.secondsHand.angle + this.secondsIncrement);
		this.minutesHand.setAngle(this.minutesHand.angle + this.minutesIncrement);
		this.hoursHand.setAngle(this.hoursHand.angle + this.hoursIncrement);
		this.elapsedTime = 0;
	}
} 